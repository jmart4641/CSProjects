' **************************************************************************************
' Author: Solution (Sale Price Calculator with More Validations)
' Date: 10/31/2019
    ...
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ...
        Try
            ...
            Catch ex As Exception
                MessageBox.Show("Enter numbers only for Discount Percentage")
                txtDiscountPercentage.Focus()
                txtDiscountPercentage.SelectAll()
            End Try

        Catch ex As Exception
            MessageBox.Show("Enter numbers only for Original Price")
