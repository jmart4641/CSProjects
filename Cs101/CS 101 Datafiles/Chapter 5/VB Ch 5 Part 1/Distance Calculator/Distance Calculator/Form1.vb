...
'             Time traveled, adn the Hours and Distance text will be displayed first. For these strings to be displayed, 
'             I used an input box for each, which allows them to be displayed in a input box.
'             A For....Next Loop is used for the times that the user-specified number of hours traveled.
