...
Partial Public Class MembersDataSet
    ...
    Partial Public Class MembersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddMembersRow(ByVal ID As Short, ByVal Full_Name As String) As MembersRow
            Dim rowMembersRow As MembersRow = CType(Me.NewRow,MembersRow)
            Dim columnValuesArray() As Object = New Object() {ID, Full_Name}
        ...
        Private Sub InitClass()
            ...
            Me.columnFull_Name.MaxLength = 62
        End Sub
...
Namespace MembersDataSetTableAdapters
    ...
    Partial Public Class MembersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Members] WHERE (([ID] = @Original_ID))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Members] SET [ID] = @ID WHERE (([ID] = @Original_ID));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, "& _ 
                "Last_Name + ', ' + First_Name AS Full_Name FROM Members WHERE (ID = @ID) ORDER B"& _ 
                "Y Last_Name"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ListBox_SelectedValue.My.MySettings.Default.KarateConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Last_Name + ', ' + First_Name As Full_Name FROM dbo.Members"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY "& _ 
                "Last_Name"
